# Личный проект «Седона111»12

* Студент: [Илья Студент](http://up.htmlacademy.loc/htmlcss/29/user/1332507).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-test/1332507-sedona-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
